...
class EventsTable extends Table
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->scalar('entry_template')
            ->maxLength('entry_template', 4294967295)
            ->allowEmptyString('entry_template');

        $validator
            ->scalar('drink')
            ->maxLength('drink', 64)
            ->allowEmptyString('drink');

        $validator
            ->scalar('food')
            ->maxLength('food', 64)
            ->allowEmptyString('food');
        ...
        $validator
            ->integer('limited_range')
            ->requirePresence('limited_range', 'create')
            ->notEmptyString('limited_range');
