...
<div class="users form large-9 medium-8 columns content">
	...
	<?= $this->Form->create($event, array('templates' => $form_template,
		'type' => 'file')); ?>
	<fieldset>
		...
		echo $this->Form->control('body', array('label' => array('text' => '詳細',
			// labelで出力するテキスト
			'class' => 'col-form-label'
			// labelタグのクラス名
		),
		...
		echo $this->Form->control('entry_template', array('label' => array('text' => '登録フォーマット',
			// labelで出力するテキスト
			'class' => 'col-form-label'
			// labelタグのクラス名
		),
		...
		echo $this->Form->control('drink', array('label' => array('text' => 'ドリンクメニュー',
			// labelで出力するテキスト
			'class' => 'col-form-label'
			// labelタグのクラス名
		),
		...
		echo $this->Form->control('food', array('label' => array('text' => 'フードメニュー',
			// labelで出力するテキスト
			'class' => 'col-form-label'
			// labelタグのクラス名
		),
		...
		echo $this->Form->control('start_time', array('label' => array('text' => '開始日時',
			// labelで出力するテキスト
			'class' => 'col-form-label'
			// labelタグのクラス名
		),
		...
		echo $this->Form->control('end_time', array('label' => array('text' => '終了日時',
			// labelで出力するテキスト
			'class' => 'col-form-label'
			// labelタグのクラス名
		),
		...
		echo $this->Form->control('budget', array('label' => array('text' => '予算',
			// labelで出力するテキスト
			'class' => 'col-form-label'
			// labelタグのクラス名
		),
		...
		echo $this->Form->control('deadline', array('label' => array('text' => '募集終了日',
			// labelで出力するテキスト
			'class' => 'col-form-label'
			// labelタグのクラス名
		),
		...
		echo $this->Form->control('entry_date', array('label' => array('text' => '募集開始日時',
			// labelで出力するテキスト
			'class' => 'col-form-label'
			// labelタグのクラス名
		),
		...
		echo $this->Form->control('limited_range', array('label' => array('text' => '応募制限',
			// labelで出力するテキスト
			'class' => 'col-form-label'
			// labelタグのクラス名
		),
		...
		echo $this->Form->control('number_of_people', array('label' => array('text' => '募集人数',
			// labelで出力するテキスト
			'class' => 'col-form-label'
			// labelタグのクラス名
		),
		...
		echo $this->Form->control('prefecture', array('label' => array('text' => '都道府県',
			...
			// inputタグのクラス名
			'disabled' => true));
		echo $this->Form->control('phone_number', array('label' => array('text' => '電話番号',
			// labelで出力するテキスト
			'class' => 'col-form-label'
			// labelタグのクラス名
		),
