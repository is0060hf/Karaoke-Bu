...
<div class="breadcrumb_div">
	<ol class="breadcrumb m-b-20">
		...
		<li class="breadcrumb-item"><a
				href="<?php echo $this->Url->build(['controller' => 'Events', 'action' => 'view',$event->id]); ?>">イベント情報詳細</a></li>
		<li class="breadcrumb-item active">イベント情報編集</li>
	</ol>
</div>
...
<div class="users form large-9 medium-8 columns content">
	...
	<?= $this->Form->create($event, array(
		'templates' => $form_template,
		'type' => 'file'
	)); ?>
	<fieldset>
		<legend><?= __('イベント情報編集') ?></legend>
		<?php
		echo $this->Form->control('title', array(
			'label' => array(
				'text' => 'タイトル',       // labelで出力するテキスト
		...
		echo $this->Form->control('entry_template', array(
			'label' => array(
				'text' => '登録フォーマット',       // labelで出力するテキスト
				'class' => 'col-form-label' // labelタグのクラス名
			),
			'type' => 'textarea',
			'templateVars' => array(
		...
		echo $this->Form->control('drink', array(
			'label' => array(
				'text' => 'ドリンクメニュー',       // labelで出力するテキスト
				'class' => 'col-form-label' // labelタグのクラス名
			),
			'type' => 'select',
			'options' => DRINK_MENU_ARRAY,
			'templateVars' => array(
				'div_class' => 'form-group row',
				'div_tooltip' => 'tooltip',
				'div_tooltip_placement' => 'top',
				'div_tooltip_title' => 'ドリンクメニューが決まっていたら選択してください。'
			),
			'id' => 'drink',
			'class' => 'form-control'      // inputタグのクラス名
		));
		echo $this->Form->control('food', array(
			'label' => array(
				'text' => 'フードメニュー',       // labelで出力するテキスト
				'class' => 'col-form-label' // labelタグのクラス名
			),
			'type' => 'select',
			'options' => FOOD_MENU_ARRAY,
			'templateVars' => array(
				'div_class' => 'form-group row',
				'div_tooltip' => 'tooltip',
				'div_tooltip_placement' => 'top',
				'div_tooltip_title' => 'フードメニューが決まっていたら選択してください。'
			),
			'id' => 'food',
			'class' => 'form-control'      // inputタグのクラス名
		));
		echo $this->Form->control('start_time', array(
			'label' => array(
				'text' => '開始日時',       // labelで出力するテキスト
				'class' => 'col-form-label' // labelタグのクラス名
			),
			'type' => 'datetime',
			'dateFormat' => 'YMD',
			...
			'templateVars' => array(
				...
				'div_tooltip' => 'tooltip',
				'div_tooltip_placement' => 'top',
				'div_tooltip_title' => 'イベントの開始日時を入力してください。'
			),
			'year' => array(
		...
		echo $this->Form->control('end_time', array(
			'label' => array(
				'text' => '終了日時',       // labelで出力するテキスト
				'class' => 'col-form-label' // labelタグのクラス名
			),
			'type' => 'datetime',
			'dateFormat' => 'YMD',
			...
			'templateVars' => array(
				...
				'div_tooltip' => 'tooltip',
				'div_tooltip_placement' => 'top',
				'div_tooltip_title' => 'イベントの終了日時を入力してください。'
			),
			'year' => array(
				'class' => 'custom-select datetime-picker'
			),
		...
		echo $this->Form->control('budget', array(
			'label' => array(
				'text' => '予算',       // labelで出力するテキスト
				'class' => 'col-form-label' // labelタグのクラス名
			),
			'type' => 'text',
			'templateVars' => array(
				...
				'div_tooltip' => 'tooltip',
				'div_tooltip_placement' => 'top',
				'div_tooltip_title' => '一人当たりのおおよその予算を入力してください。'
			),
			'class' => 'form-control'      // inputタグのクラス名
		));
		echo $this->Form->control('deadline', array(
			'label' => array(
				'text' => '募集終了日',       // labelで出力するテキスト
				'class' => 'col-form-label' // labelタグのクラス名
			),
			'type' => 'datetime',
			'dateFormat' => 'YMD',
			...
			'templateVars' => array(
				...
				'div_tooltip' => 'tooltip',
				'div_tooltip_placement' => 'top',
				'div_tooltip_title' => '応募締め切り日時を入力してください。'
			),
			'year' => array(
				'class' => 'custom-select datetime-picker'
			),
		...
		echo $this->Form->control('entry_date', array(
			'label' => array(
				'text' => '募集開始日時',       // labelで出力するテキスト
				'class' => 'col-form-label' // labelタグのクラス名
			),
			'type' => 'datetime',
			'dateFormat' => 'YMD',
			...
			'templateVars' => array(
				...
				'div_tooltip' => 'tooltip',
				'div_tooltip_placement' => 'top',
				'div_tooltip_title' => '参加者を募集開始する日時を入力してください。'
			),
			'year' => array(
				'class' => 'custom-select datetime-picker'
			),
		...
		echo $this->Form->control('limited_range', array(
			'label' => array(
				'text' => '応募制限',       // labelで出力するテキスト
				'class' => 'col-form-label' // labelタグのクラス名
			),
			'type' => 'select',
			'options' => LIMITED_RANGE_ARRAY,
			'templateVars' => array(
				'div_class' => 'form-group row',
				'div_tooltip' => 'tooltip',
				'div_tooltip_placement' => 'top',
				'div_tooltip_title' => 'このイベントに応募できる人を制限できます。'
			),
			'id' => 'limited_range',
			'class' => 'form-control'      // inputタグのクラス名
		));
		echo $this->Form->control('number_of_people', array(
			'label' => array(
				'text' => '募集人数',       // labelで出力するテキスト
				'class' => 'col-form-label' // labelタグのクラス名
			),
			'type' => 'text',
			'templateVars' => array(
				...
				'div_tooltip' => 'tooltip',
				'div_tooltip_placement' => 'top',
				'div_tooltip_title' => 'このイベントの募集人数を入力してください。'
			),
			'class' => 'form-control'      // inputタグのクラス名
		));
		...
		echo $this->Form->control('phone_number', array(
			...
			'templateVars' => array(
				...
				'div_tooltip' => 'tooltip',
				'div_tooltip_placement' => 'top',
				'div_tooltip_title' => '緊急連絡先を登録したい場合は入力してください。'
			),
			'class' => 'form-control'      // inputタグのクラス名
		));
		?>
