...
<div class="breadcrumb_div">
	<ol class="breadcrumb m-b-20">
		...
		<li class="breadcrumb-item"><a
				href="<?php echo $this->Url->build(['controller' => 'Events', 'action' => 'view', $event->id]); ?>">イベント情報詳細</a>
		</li>
...
<div class="users form large-9 medium-8 columns content">
	...
	<fieldset>
		...
		echo $this->Form->control('body', array('label' => array('text' => '詳細',       // labelで出力するテキスト
			'class' => 'col-form-label' // labelタグのクラス名
		), 'type' => 'textarea', 'templateVars' => array('div_class' => 'form-group row'), 'required' => true, "id" => "summernote", 'class' => 'form-control'      // inputタグのクラス名
		));
		echo $this->Form->control('entry_template', array('label' => array('text' => '登録フォーマット',       // labelで出力するテキスト
			'class' => 'col-form-label' // labelタグのクラス名
		), 'type' => 'textarea', 'templateVars' => array('div_class' => 'form-group row'), "id" => "summernote2", 'class' => 'form-control'      // inputタグのクラス名
		));
