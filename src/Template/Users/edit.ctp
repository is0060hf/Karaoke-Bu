...
<div class="users form large-9 medium-8 columns content">
	...
	<fieldset>
		...
		echo $this->Form->control('prefecture', array('label' => array('text' => '都道府県',       // labelで出力するテキスト
			'class' => 'col-form-label' // labelタグのクラス名
		), 'type' => 'select', 'options' => PREFECTURE_ARRAY, 'templateVars' => array('div_class' => 'form-group row', 'div_tooltip' => 'tooltip', 'div_tooltip_placement' => 'top', 'div_tooltip_title' => '住んでいる都道府県を選択してください。'), 'id' => 'prefecture', 'value' => $user->prefecture, 'class' => 'form-control',      // inputタグのクラス名
		));
