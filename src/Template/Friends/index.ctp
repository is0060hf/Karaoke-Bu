		...
		<?php foreach ($friends as $friend): ?>
			...
			<tr>
				<td class="align-middle"><a
						href="<?php echo $this->Url->build(['controller' => 'Users', 'action' => 'view', $friend->dest_friend]); ?>"
				...
				<td class="align-middle actions">
					<?= $this->Form->postLink(__('削除'), ['action' => 'delete', $friend->id], ['confirm' => __('本当に削除してもよろしいでしょうか # {0}?', $friend->id)]) ?>
				</td>
			</tr>
		<?php endforeach; ?>
		</tbody>
