...
<div class="row">
	...
	<div class="col-6 text-right">
		<a href="<?= $this->Url->build(['controller' => 'Teams', 'action' => 'add']); ?>" class="btn btn-success mt-2">
		...
		<?php foreach ($teams as $team): ?>
			<tr>
				<td class="align-middle"><a
						href="<?php echo $this->Url->build(['controller' => 'Teams', 'action' => 'view', $team->id]); ?>"
				...
				<td class="align-middle actions">
					<?= $this->Html->link(__('編集'), ['action' => 'edit', $team->id]) ?>
					<?= $this->Form->postLink(__('削除'), ['action' => 'delete', $team->id], ['confirm' => __('本当に削除してもよろしいでしょうか # {0}?', $team->id)]) ?>
				</td>
			</tr>
		<?php endforeach; ?>
		</tbody>
