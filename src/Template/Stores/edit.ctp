...
<div class="breadcrumb_div">
	<ol class="breadcrumb m-b-20">
		<li class="breadcrumb-item"><a
				href="<?php echo $this->Url->build(['controller' => 'Stores', 'action' => 'index']); ?>">Home</a></li>
		<li class="breadcrumb-item"><a
				href="<?php echo $this->Url->build(['controller' => 'Stores', 'action' => 'index']); ?>">店舗情報一覧</a></li>
		<li class="breadcrumb-item"><a
				href="<?php echo $this->Url->build(['controller' => 'Stores', 'action' => 'view', $store->id]); ?>">店舗情報詳細</a>
		</li>
...
<div class="users form large-9 medium-8 columns content">
	...
	<fieldset>
		...
		<?php
		echo $this->Form->control('store_name', array('label' => array('text' => '店舗名',       // labelで出力するテキスト
			'class' => 'col-form-label' // labelタグのクラス名
		), 'type' => 'text', 'templateVars' => array('div_class' => 'form-group row', 'div_tooltip' => 'tooltip', 'div_tooltip_placement' => 'top', 'div_tooltip_title' => '店舗名称を入力してください。'), 'class' => 'form-control'      // inputタグのクラス名
		));
		echo $this->Form->control('store_url', array('label' => array('text' => 'サイトURL',       // labelで出力するテキスト
			'class' => 'col-form-label' // labelタグのクラス名
		), 'type' => 'text', 'templateVars' => array('div_class' => 'form-group row', 'div_tooltip' => 'tooltip', 'div_tooltip_placement' => 'top', 'div_tooltip_title' => '店舗公式ページのURLを入力してください。'), 'class' => 'form-control'      // inputタグのクラス名
		));
	...
	<div class="row mt-4">
		<div class="col-12 text-center">
			...
			<a href="<?= $this->Url->build(['controller' => 'Stores', 'action' => 'view', $store->id]); ?>"
				 class="btn btn-info">
